...
class PatternsControllerTest < ActionController::TestCase
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post :create, pattern: { beats: @pattern.beats, hex: @pattern.hex, name: @pattern.name, steps: @pattern.steps }
    end
  ...
  test "should update pattern" do
    patch :update, id: @pattern, pattern: { beats: @pattern.beats, hex: @pattern.hex, name: @pattern.name, steps: @pattern.steps }
    assert_redirected_to pattern_path(assigns(:pattern))
  end
